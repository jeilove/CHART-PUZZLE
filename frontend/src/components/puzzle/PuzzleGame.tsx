      ...
      >
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-10 flex justify-center z-500">
            ...
            >
              <img src="/icons/v13_trigger.png" alt="Intelligence Trigger" className="h-24 w-24 object-contain shadow-2xl drop-shadow-[0_0_20px_rgba(240,128,128,0.4)] transition-all group-hover:scale-110" />
        ...
        >
          ...
          <div className="absolute top-8 inset-x-0 flex flex-col items-center gap-2 px-8">
            <div className="absolute top-2 left-4">
               <img src="/icons/v13_trigger.png" alt="Intelligence" className="h-16 object-contain drop-shadow-[0_0_20px_rgba(244,63,94,0.3)] brightness(1.1)" />
            </div>
